  ...
  <div class="app-container">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="70px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item>
          <el-upload class="upload-file" drag :action="doUpload" :file-list="fileList" :on-change="handleFileChange" accept="image/jpeg,image/gif,image/png,image/bmp" :on-success="handleUploadSuccess">
            <i class="el-icon-upload" />
            <div class="el-upload__text">将文件拖到此处，或<em>点击上传</em></div>
          </el-upload>
        </el-form-item>
        <el-form-item label="名称" prop="name">
          <el-input v-model="temp.vendor_name" />
        </el-form-item>
...
import { fetchVendorList, deleteVendor, createVendor } from '@/api/vendor'
...
export default {
  ...
  data() {
    return {
      doUpload: 'http://47.104.226.188:8009/post',
      fileList: [],
      bannerImg: '',
      tableKey: 0,
      list: null,
  ...
  methods: {
    ...
    createData() {
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          ...
          createVendor(this.temp).then(response => {
    ...
    dropzoneS(file) {
      var uid = JSON.parse(file.xhr.responseText)
      console.log(uid['fileuid'])
      this.temp['banner'] = uid['fileuid']
